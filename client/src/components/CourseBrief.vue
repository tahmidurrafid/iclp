                ...
                <div v-for="(topic,i) in course.topics" v-bind:key="i" class = "topic">
                    <div class = "topic-wrapper" v-if = "topic.type=='topic'">
                        <div class = "topic-title">
                            ...
                            <div class = "actions">
                                <router-link class = "expand" :to="'/course/complete?id=' + course.id + '&topic=' + topic.topic_id">
                    ...
                    <div class = "assignment-wrapper" v-if = "topic.type=='assignment'">
                        <div class = "topic-title">
                            <div class = "text">{{topic.title}} </div>
                            <div class = "actions">
                                <router-link class = "expand" :to="'/course/submitassignment?course=' + course.id + '&assignment=' + topic.id">
                                    <i class="fa fa-angle-right" ></i>
                                </router-link>
                            </div>
                        </div>
